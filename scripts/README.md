...
Due to network restrictions or Cloudflare protection, some networks may return a 403 error. 
In that case, we can manually save the JSON response from your browser as `users.json` and run the script using the local file.
